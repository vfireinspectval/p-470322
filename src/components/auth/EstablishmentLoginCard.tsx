...
export const EstablishmentLoginCard: React.FC = () => {
  return (
    <main className="flex justify-center pt-[159px]">
      <div className="w-[605px] h-auto min-h-[564px] border relative bg-neutral-100 rounded-[20px] border-solid border-[#524F4F] max-md:w-[90%] max-md:max-w-[605px] max-sm:h-auto max-sm:pt-5 max-sm:pb-10 max-sm:px-0">
        <img
        ...
        />
        <h2 className="text-[#F00] text-[40px] font-bold text-center mt-[156px] max-sm:text-[32px] max-sm:mt-[120px]">
